...
//        updateStatus("offline")
    ...
    func applicationDidBecomeActive(application: UIApplication) {
        ...
        NSNotificationCenter.defaultCenter().postNotification(NSNotification(name: "appIsActive", object: nil, userInfo: nil))
    ...
    func applicationWillTerminate(application: UIApplication) {
        ...
        defaults.setObject(nil, forKey: "hashToken")
    }
    
    func application(application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: NSData) {
        let token: String! = deviceToken.description.stringByTrimmingCharactersInSet(NSCharacterSet(charactersInString: "<>")).stringByReplacingOccurrencesOfString(" ", withString: "")
        let defaults = NSUserDefaults.standardUserDefaults()
    ...
    func application(application: UIApplication, didFailToRegisterForRemoteNotificationsWithError error: NSError) {
        if error.code == 3010 {
            NSUserDefaults.standardUserDefaults().setObject("simulatorDeviceKey", forKey: "deviceToken")
        }
    ...
    func application(application: UIApplication, didReceiveRemoteNotification userInfo: [NSObject : AnyObject]) {
        ...
        NSNotificationCenter.defaultCenter().postNotification(NSNotification(name: "pushNotification", object: userInfo, userInfo: userInfo))
    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("TurntData", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("TurntData.sqlite")
